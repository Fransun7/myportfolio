    ...
    <div className="text-white mt-7 w-screen">
      ...
      >
        ...
        <div className="p-4 text-black font-roboto-mono font-bold text-xl row-span-2 ">
          ...
          <p className="mt-5">
            "As a <span class="text-amber-950">front-end developer</span>, I am
            a problem-solver and a creator. I love using{" "}
            ...
            interactive interfaces that feel fast intuitive. Every line of code
            i write is a step toward user experience. I am always excited to
            learn, grow, and build something new."
          </p>
        </div>
      </div>
      {/* footer */}
      <footer className="bg-black">
        <form class=" text-neutral-800 py-6 relative overflow-hidden flex flex-col justify-around w-screen border border-neutral-500 rounded-lg  p-3 px-6">
          ...
          <div class="flex gap-1">
            <div class="relative rounded-lg w-64 overflow-hidden before:absolute before:w-12 before:h-12 before:content[''] before:right-0 before:bg-violet-500 before:rounded-full before:blur-lg after:absolute after:z-10 after:w-20 after:h-20 after:content[''] after:bg-rose-300 after:right-12 after:top-3 after:rounded-full after:blur-lg">
              <input
                type="text"
                class="relative bg-transparent ring-0 outline-none border border-neutral-500 text-white placeholder-violet-700 text-sm rounded-lg focus:ring-violet-500 placeholder-opacity-60 focus:border-violet-500 block w-full p-2.5 checked:bg-emerald-500"
                placeholder="Mail..."
              />
            </div>
